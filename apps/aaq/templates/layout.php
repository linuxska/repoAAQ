...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  <head>
    ...
    <?php include_metas() ?>
    <title><?php include_slot('title', 'AAQ')?></title>
  ...
  <body>
      <div id="wrapper">
          <div id="header">
              <div id="logos">
                <img alt="Aire Acondicioando de Queretaro" src="/images/logos/banner.jpg" />
              </div>
          </div>
          <div id="content" class="ipe_admin_content">
              ...
              <?php include_partial('aaq/menu', array('sf_user'=>$sf_user));?>
              <div id="workspace">
                    <?php echo $sf_content ?>
              </div>
          </div>
          <div class="rp_admin_footer">
      <p> <?php echo date('Y', time());?> <a href="http://www.google.com.mx">Aire Acondicioando de Queretaro</a>.
